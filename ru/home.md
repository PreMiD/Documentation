...
- :link: [Что такое RPC?](https://discordapp.com/rich-presence) Всё о Rich Presence и его функциях.

# Приступаем к работе

PreMiD устанавливается быстро и легко. Вы сможете запустить его вмиг.
...
- :wrench: [Разработка Presence](/dev/presence): Изучите, как использовать нашу систему Presence.
