...
Uma conexão com a internet é necessária para executar o PreMiD. PreMiD will automatically check for new updates, languages, Presence updates, etc. from time to time.
