...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Nhận thông tin Discord của Nhân viên và Cộng tác viên PreMiD / một người dùng cụ thể, sử dụng ID người dùng Discord. Phải ở trong server Discord của chúng tôi.</td>
    </tr>
    <tr>
