...
- Luôn thêm số phiên bản tuân theo [tiêu chuẩn sematic versioning](https://semver.org), có khuân mẫu như sau: `<MAJOR>.<MINOR>.<PATCH>`. Những thứ khác như `1.0.0.1`, `1.0`, `1`, `1.0.0-BETA` hoặc đổi từ `1.0.0` sang `2.0.0` sau một bản sửa lỗi/thay đổi nhỏ là **không** được cho phép.
