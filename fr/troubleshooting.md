...
**Paramètres utilisateur** > **Activité de jeu** ![gameactivity_edited.png](/activitystatus.png)
...
Windows: Écrivez `%appdata%` et supprimez le dossier `PreMiD`. MacOS :`~/users/USER/~Library/Application Support/`et supprimez le dossier`PreMiD`.
...
Ne vous inquiétez pas. Appuyez sur <kbd>CTRL+R</kbd> (pour Windows) ou <kbd>CMD+R</kbd> (sur MacOS) tout en restant sur Discord pour recharger l'application.
