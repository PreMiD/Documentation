...
published: true
date: 2021-10-30T23:13:08.651Z
tags: 
editor: markdown
dateCreated: 2021-09-07T01:40:22.171Z
---
...
This property is required to make your presence work, because it uses your application id to display its logo and assets. U kan dit op u [toepassingsbladsy](https://discordapp.com/developers/applications).
...
Tweede parameter definieer wanneer teenwoordigheid iets speel of nie. Always use `true` if you provide timestamps in `PresenceData`.
...
'N Asynkrone metode waarmee u vertaalde snare van die uitbreiding kan kry.

You must provide `Voorwerp` met sleutels wat die sleutel vir toutjies is, `sleutelwaarde` is die stringwaarde. A list of translated strings can be found at this endpoint: `https://api.premid.app/v2/langFile/presence/en/`
