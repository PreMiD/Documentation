...
Kanggo ngatasi iki, sampeyan mung kudu ngaktifake pilihan setelan ndhuwur: ![presencesettings.gif](/presencesettings.gif)

### Restart browsermu
<kbd>Alt</kbd>+<kbd>F4</kbd> (Windows) utawa <kbd>CMD</kbd>+<kbd>Q</kbd> (MacOS) bekerja juga. (Wis jelas sampeyan kudu mbukak browser maneh.)

### Restart PreMiD (Aplikasi)
![quit.png](/quit.png) Sampeyan kudu restart maneh PreMiD sawise iku.
