...
> Användare av Aur som använder DoomLerd's package bör vara säkra som han säger. We are not recommending to use it, but if you want you can still use it. Thanks to DoomLerd for handling aur repo still. 
> 
> {.is-warning}
