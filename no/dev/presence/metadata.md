...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">Bør inneholde et objekt med <code>navnet</code> og <code>id</code> av tilstedeværelsesutvikleren. <code>navnet</code> er ditt Discord brukernavn uten identifikator(#0000). User <code>id</code> can be copied from Discord by enabling developer
    ...
    <tr>
      ...
      <td style="text-align:left">Should contain an Object with the <code>name</code> and <code>id</code> of the contributor. <code>name</code> is your Discord username without the identifier(#0000). Bruker <code>-id</code> kan kopieres fra Discord ved å aktivere utvikler
