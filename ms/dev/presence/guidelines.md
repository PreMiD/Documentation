...
- `Codacy` ialah bot yang memeriksa kualiti kod. Jika anda menerima ralat untuk isu baharu, anda **diwajibkan** membaikinya. (_AMARAN: Bot Codacy akan dibuang tidak lama lagi dan DeepScan akan menggantikannya!_)
