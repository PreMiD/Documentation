...
published: true
date: 2021-10-18T16:38:49.085Z
tags: 
editor: markdown
dateCreated: 2021-09-07T02:00:42.187Z
---
...
- Presences **повинні** бути пов'язані з обраним веб-сайтом.
- Presences **cannot** be made for illegal websites. (наприклад, стресори, торгівля наркотиками, дитяча порнографія тощо)
- The file structure must be clean and managed, do not include files which are not specified. (наприклад: папки vscode і git, зображення і текстові файли і т. д.)
...
- Presences with support for only a single subdomain will **not** be permitted, as they may seem broken for other pages (like the homepage), exceptions can be made for the policy and contact pages (content that isn't used often) or sites where the other content is unrelated. (напр., wiki-сторінки)
