...
Nuestro objetivo principal es trabajar con los usuarios para tratar de ser muy amistosos, respetuosos e informativos como sea posible. Simplemente mencionando a un desarrollador en nuestro [servidor de Discord](https://discord.gg/WvfVZ8T) para obtener aprobación en GitHub, o no. Depende de la calidad del código, la apariencia de los activos y la funcionalidad regular.